...
Access to {{companyShortName}} systems and application is limited for all users, including
...
in {{companyShortName}} security standards.
...
limited to resources in {{companyShortName}} production environments.
...
accounts terminated within the defined, predetermined timeframe.
...
securely and stored in encrypted vaults that meet the {{companyShortName}} data encryption
standards.
